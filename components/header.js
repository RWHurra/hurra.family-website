class THeader extends HTMLElement {
    ...
    connectedCallback() {
        ...
        <header>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" class="ham" style="fill: white"><!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
